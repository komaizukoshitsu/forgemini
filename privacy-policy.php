...
<main data-barba="container" data-barba-namespace="page">
    <div class="w-[90%] xl:max-w-180 mx-auto mt-16">
        <article class="">
            <header class="">
                <h1 class="text-center xl:text-left text-[32px] xl:text-[45px] font-garamond italic tracking-[0.15em] leading-[1.25]">Privacy Policy</h1>
            </header>

            <div class="mt-7 xl:mt-[84px] flex flex-col xl:flex-row">
                <div class="w-full xl:w-75 xl:flex-shrink-0">
                    <?php
                ...
                <div class="w-full xl:flex-1">
                    <p class="tracking-wide mt-5 xl:mt-0 text-sm xl:text-base leading-[1.75]">
            ...
            <div class="mt-10 flex flex-col xl:flex-row">
                ...
                <div class="w-full xl:flex-1">
                    <p class="tracking-wide mt-5 xl:mt-0 text-sm xl:text-base leading-[1.75]">
                        ...
                        <ul class="tracking-wide list-disc pl-5 text-[14px] xl:text-base" style="line-height:1.75">
            ...
            <div class="mt-10 flex flex-col xl:flex-row">
                ...
                <div class="xl:w-[calc(100%-290px)]">
                    <ul class="tracking-wide mt-5 xl:mt-0 text-sm xl:text-base leading-[1.75]">
            ...
            <div class="mt-10 text-right text-xs xl:text-base" style="line-height:1.75">2024年00月00日制定</div>
        </article>
