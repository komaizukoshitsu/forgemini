...
<div class="swiper goods-main mb-2 lg:mb-4">
    <div class="swiper-wrapper mb-2 lg:mb-4">
        <?php
        ...
        ?>
                <div class="swiper-slide">
                    <div class="aspect-square overflow-hidden bg-gray-100 rounded-[10px] lg:rounded-[20px]">
    ...
    <div class="hidden lg:flex absolute inset-y-1/2 left-0 right-0 z-10 -translate-y-1/2 justify-between px-4">
