        ...
        <div class="bg-white pb-10 lg:pb-25">
            ...
            <section class="mt-15 lg:-mt-60">
                <div class="w-full lg:w-[85%] max-w-306 mx-auto">
                    ...
                    <?php
                    $today = date('Y-m-d'); // 今日の日付を取得（例: 2025-04-25）
                    ...
                    if ($today_event_query->have_posts()) :
                        while($today_event_query->have_posts()) : $today_event_query->the_post();
                            ?>
                            <div class="lg:flex gap-25 items-end lg:items-center mt-5 lg:mt-15">
                                <div class="w-full lg:w-[682px]">
                                    <a href="<?php the_permalink(); ?>" class="block w-full group">
                                        <div class="px-[5%] lg:px-0">
                                            <div class="overflow-hidden w-full rounded-[10px] lg:rounded-[20px] aspect-[4/3]">
                                ...
                                <div class="w-[84%] lg:w-[370px] mx-auto lg:mx-0 mt-7 lg:mt-0">
                                    <div class="hidden lg:block">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/image/wavy-line.svg" alt="上波線" loading="lazy" width="100%" height="100%">
                                    </div>
                                    <div class="flex mt-5 lg:mt-10 items-center">
                                        <?php get_template_part('templates/event/event-status'); ?>
                                        <p class="text-[10px] lg:text-xs h-5 lg:h-6 px-[6px] inline-flex items-center justify-center ml-1 lg:ml-2 border border-[#333] rounded-[12px]">
                                            <?php
                                            $tags = get_the_tags();
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="group block w-fit">
                                        <div class="mt-2 lg:mt-3 text-sm lg:text-[18px] font-medium leading-[1.5] relative w-fit">
                                    ...
                                    <dl class="mt-5 lg:mt-10 space-y-2 lg:space-y-3 leading-[1.3] tracking-[0.05em]" style="font-family: 'Open Sans', sans-serif;">
                                    ...
                                    <div class="mt-7 lg:mt-12 text-center">
                                        <?php get_template_part('templates/common/link-button', null, [
                                            'url' => get_permalink(),
                                            'label' => 'View More'
                                        ]); ?>
            ...
            <section class="mt-15 lg:mt-75">
                <div class="youtube-iframe relative overflow-hidden w-full h-[80vh] md:h-screen">
                    ...
                    <!-- <video
                        src="<?php echo get_template_directory_uri(); ?>/assets/image/youtube.mp4"
                ...
                <div class="w-full lg:w-[85%] max-w-306 mx-auto">
                    ...
                    if ($query->have_posts()) :
                        ...
                        while ($query->have_posts()) : $query->the_post();
                            // $terms = get_the_terms(get_the_ID(), 'works-tags'); // カスタムタクソノミースラッグに変更
            ...
            <section class="mt-30 lg:mt-60">
                <?php
                // get_template_part('templates/swiper/swiper-top');
                ?>
                <?php
                get_template_part('templates/swiper/swiper-default', null, array(
                    'category_slug' => 'works' // ← カテゴリースラッグを渡す
                ));
                ?>
                    ...
                    <div class="lg:w-[75%] lg:mx-auto lg:flex xl:max-w-270 gap-[90px]">
                        <div class="lg:w-[48%] flex flex-col">
                            <div class="top-suzuri-service bg-[#FFFAD1] rounded-[10px] lg:rounded-[20px]">
                                <a href="<?php the_permalink(); ?>" class="flex items-center py-4 lg:py-6 px-5 lg:px-10 gap-[20px] lg:gap-10">
                        ...
                        <div class="lg:w-[48%] mt-5 lg:mt-0 bg-[#FFF] rounded-[10px] lg:rounded-[20px] flex flex-col justify-between">
                            <div class="pt-8 lg:pt-15 px-5 lg:px-[50px]">
                                ...
                                <div class="mt-6 lg:mt-8 text-center">
                                    <!-- <a href="<?php bloginfo('url');?>/about" class="link">View More</a> -->
                                    <?php get_template_part('templates/common/link-button', null, [
                                        'url' => home_url('/about'),
                                        'label' => 'View More'
                                    ]); ?>
            ...
            <section class="mt-8 lg:mt-30 overflow-hidden">
                <!-- <div class="flex gap-2 lg:gap-4">
                    <div class="instagram-slide"><?php echo do_shortcode('[instagram-feed feed=2]'); ?></div>
                    <div class="instagram-slide"><?php echo do_shortcode('[instagram-feed feed=2]'); ?></div>
                    <div class="instagram-slide"><?php echo do_shortcode('[instagram-feed feed=2]'); ?></div>
                </div> -->
                <?php
                ...
                <div class=" text-center">
                    <a href="https://www.instagram.com/teraoka_natsumi/" class="inline-block" target="_blank">
                        <div class="flex">
