...
<a href="<?php echo esc_url($url); ?>" class="group relative inline-flex items-center pr-5 text-base xl:text-[18px] leading-[1.25] tracking-[0.05em] italic font-garamond font-semibold">
